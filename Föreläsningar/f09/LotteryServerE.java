...
//			Thread.sleep(10000);
	...
	// synchronisering behövs ofta då flera trådar använder samma resurs.
	...
	public void run() {
		System.out.println("ServerE running");
		while(true) {
			try  {
