...
public class DemoQuizClient1 {
	...
	private class Communicate extends Thread {
		public void run() {
			...
			while(true) {
				try {
					request = JOptionPane.showInputDialog("Ange request på formen:\n  * 'QUESTION,FrågaNr'\n  * 'ANSWER,FrågaNr,Årtal'"+
				                                          "\nFrågaNr ska vara 1-20\nÅrtal ska vara fyra siffror\n");
					if(request==null)
						break;
			...
			System.out.println("\nDemoQuizClient avslutas");
		}
	}
	
	public static void main(String[] args) {
		new DemoQuizClient1("195.178.227.53",1494);
	}
}
